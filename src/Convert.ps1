...
$title = "<h1><img src=`"qedilogodevice_white.png`"> hub2 Roadmap</h1>
<div>
...
# works correctly
import-csv Filter.csv | ConvertTo-Html -head $header -PreContent $title -PostContent $key | Out-File -Encoding utf8 ..\index.html
